namespace ChapeauUI
{
    partial class WaiterView
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelTableStatus = new Panel();
            buttonAddOrder = new Button();
            buttonFreeTable = new Button();
            ServeButton = new Button();
            listViewOrderStatus = new ListView();
            OrderId = new ColumnHeader();
            Status = new ColumnHeader();
            WaitTime = new ColumnHeader();
            ...
            panelTableStatus.SuspendLayout();
            SuspendLayout();
            // 
            // topMenu
            // 
            ...
            topMenu.Size = new Size(1480, 117);
            topMenu.TabIndex = 1;
            // 
            // pnlMenuMenu
            // 
            ...
            tableLayoutPanelTable.ColumnStyles.Add(new ColumnStyle());
            tableLayoutPanelTable.ColumnStyles.Add(new ColumnStyle());
            tableLayoutPanelTable.Location = new Point(58, 190);
            ...
            tableLayoutPanelTable.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            tableLayoutPanelTable.Size = new Size(1397, 749);
            tableLayoutPanelTable.TabIndex = 2;
            // 
            // pnlMenu
            // 
            pnlMenu.BackColor = Color.White;
            pnlMenu.Controls.Add(btnClearOrder);
            pnlMenu.Controls.Add(btnPlaceOrder);
            ...
            // btnClearOrder
            // 
            btnClearOrder.BackColor = Color.Firebrick;
            btnClearOrder.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point);
            btnClearOrder.ForeColor = SystemColors.ControlLightLight;
            btnClearOrder.Location = new Point(1207, 26);
            btnClearOrder.Margin = new Padding(6);
            btnClearOrder.Name = "btnClearOrder";
            btnClearOrder.Size = new Size(158, 49);
            ...
            // btnPlaceOrder
            // 
            btnPlaceOrder.BackColor = Color.FromArgb(113, 161, 209);
            btnPlaceOrder.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            btnPlaceOrder.Location = new Point(966, 747);
            btnPlaceOrder.Margin = new Padding(6);
            btnPlaceOrder.Name = "btnPlaceOrder";
            btnPlaceOrder.Size = new Size(498, 73);
            ...
            pnlOrderItemList.Font = new Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point);
            pnlOrderItemList.ForeColor = Color.Black;
            pnlOrderItemList.Location = new Point(966, 79);
            pnlOrderItemList.Margin = new Padding(6);
            pnlOrderItemList.Name = "pnlOrderItemList";
            pnlOrderItemList.Size = new Size(494, 650);
            ...
            pnlMenuCrud.Size = new Size(1480, 939);
            ...
            radioButtonIsAlcoNo.Click += radioButtonIsAlcoNo_CheckedChanged;
            // 
            ...
            radioButtonIsAlcoYes.Click += radioButtonIsAlcoYes_CheckedChanged;
            // 
            // textBoxMenuPrice
            // 
            ...
            // panelTableStatus
            // 
            panelTableStatus.Controls.Add(buttonAddOrder);
            panelTableStatus.Controls.Add(buttonFreeTable);
            panelTableStatus.Controls.Add(ServeButton);
            panelTableStatus.Controls.Add(listViewOrderStatus);
            panelTableStatus.Location = new Point(0, 113);
            panelTableStatus.Margin = new Padding(4, 2, 4, 2);
            panelTableStatus.Name = "panelTableStatus";
            panelTableStatus.Size = new Size(1486, 847);
            panelTableStatus.TabIndex = 16;
            // 
            // buttonAddOrder
            // 
            buttonAddOrder.BackColor = Color.FromArgb(113, 161, 209);
            buttonAddOrder.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
            buttonAddOrder.Location = new Point(1068, 416);
            buttonAddOrder.Margin = new Padding(4, 2, 4, 2);
            buttonAddOrder.Name = "buttonAddOrder";
            buttonAddOrder.Size = new Size(345, 90);
            buttonAddOrder.TabIndex = 4;
            buttonAddOrder.Text = "AddOrder";
            buttonAddOrder.UseVisualStyleBackColor = false;
            buttonAddOrder.Click += buttonAddOrder_Click;
            // 
            // buttonFreeTable
            // 
            buttonFreeTable.BackColor = Color.FromArgb(113, 161, 209);
            buttonFreeTable.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
            buttonFreeTable.Location = new Point(1068, 143);
            buttonFreeTable.Margin = new Padding(4, 2, 4, 2);
            buttonFreeTable.Name = "buttonFreeTable";
            buttonFreeTable.Size = new Size(345, 90);
            buttonFreeTable.TabIndex = 3;
            buttonFreeTable.Text = "Free Table";
            buttonFreeTable.UseVisualStyleBackColor = false;
            buttonFreeTable.Click += buttonFreeTable_Click;
            // 
            // ServeButton
            // 
            ServeButton.BackColor = Color.FromArgb(113, 161, 209);
            ServeButton.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
            ServeButton.Location = new Point(308, 663);
            ServeButton.Margin = new Padding(4, 2, 4, 2);
            ServeButton.Name = "ServeButton";
            ServeButton.Size = new Size(345, 90);
            ServeButton.TabIndex = 2;
            ServeButton.Text = "Serve";
            ServeButton.UseVisualStyleBackColor = false;
            ServeButton.Click += ServeButton_Click;
            // 
            // listViewOrderStatus
            // 
            listViewOrderStatus.BackColor = SystemColors.Window;
            listViewOrderStatus.Columns.AddRange(new ColumnHeader[] { OrderId, Status, WaitTime });
            listViewOrderStatus.ForeColor = SystemColors.InfoText;
            listViewOrderStatus.FullRowSelect = true;
            listViewOrderStatus.Location = new Point(48, 79);
            listViewOrderStatus.Margin = new Padding(4, 2, 4, 2);
            listViewOrderStatus.Name = "listViewOrderStatus";
            listViewOrderStatus.Size = new Size(908, 527);
            listViewOrderStatus.TabIndex = 0;
            listViewOrderStatus.UseCompatibleStateImageBehavior = false;
            listViewOrderStatus.View = View.Details;
            // 
            // OrderId
            // 
            ...
            ClientSize = new Size(1480, 939);
            Controls.Add(topMenu);
            Controls.Add(panelTableStatus);
            ...
            panelTableStatus.ResumeLayout(false);
            ResumeLayout(false);
        }
